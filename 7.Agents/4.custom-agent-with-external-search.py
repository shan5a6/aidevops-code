...
# Google search 
# ====================================================
class OpenWebSearchTool(BaseTool):
    name: str = "web_search"
    description: str = "Searches the web for general questions"

    def _run(self, query: str, run_manager: Optional[CallbackManagerForToolRun] = None) -> str:
        # Use num_results instead of max_results
...
tools = [CustomSearchTool(), OpenWebSearchTool()]
